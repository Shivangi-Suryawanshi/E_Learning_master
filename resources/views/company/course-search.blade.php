...
<div class="page-content">
   <header>
      <div class="row">
         <div class="col-md-6">
            <h1 class="mb-0" id="hedn">Search Courses</h1>
         </div>
      </div>
   </header>
         ...
         <div class="row mt20">
            ...
            <div class="col-md-5">
               <div class="form-group">
                  ...
                  <select id="company_course" name="company_course" data-toggle="select2" data-search="true" class="form-control company_courses">
                  </select>
         ...
         <div class="row mt20">
            <div class="col-md-3">
               <ul class="nav nav-tabs flex-column tabs-sidelined sideline-right nav-vertical-tabs-animated nav-vertical-tabs-bg-animated h-auto">
                  ...
                  <li class="nav-item">
                     <a class="nav-link active" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true">Select Employees</a>
                  </li>
                  <li class="nav-wall wall-left has-left-arrow"></li>
               </ul>
            </div>
            <div class="col-md-3">
               <div class="form-group">
                  <label for="">Department</label>
                  <select id="employee_department" name="employee_department" data-toggle="select2" data-search="true" class="form-control getEmp" multiple>
                  </select>
               </div>
            </div>
            <div class="col-md-3">
               <div class="form-group">
                  ...
                  <select id="employee_position" name="employee_position[]" data-toggle="select2" data-search="true" class="form-control getEmp" multiple>
                  </select>
               </div>
            </div>
            <div class="col-md-3">
               <div class="form-group">
                  ...
                  <select id="employee_project" name="employee_project" data-toggle="select2" data-search="true" class="form-control getEmp" multiple>
                  </select>
               </div>
            </div>
   ...
   <div class="panel panel-light">
      <div class="panel-header">
         <h1 class="panel-title">Find Course</h1>
      </div>
      <div class="container">
         ...
         <div class="row mt20 mb20">
            <div class="col-md-2">
               <div class="form-group">
                  ...
                  <input type="text" id="keyword" name="keyword"  class="form-control form-control-lg keyword">
               </div>
            </div>
            <div class="col-md-2">
               <div class="form-group">
                  <label for="">Skills</label>
                  <select id="skills" name="skills[]" data-toggle="select2" data-search="true" class="form-control" multiple>
                  </select>
               </div>
            </div>
            <div class="col-md-3">
               <div class="form-group">
                  ...
                  <select id="occupation" name="occupation[]" data-toggle="select2" data-search="true" class="form-control" multiple>
                  </select>
               </div>
            </div>
            <div class="col-md-3">
               <div class="form-group">
                  ...
                  <select id="industry" name="industry[]" data-toggle="select2" data-search="true" class="form-control" multiple>
                  </select>
               </div>
            </div>
            <div class="col-md-2">
               ...
               <div class="form-group ">
                  ...
                  <button type="button" class="m-1 btn btn-dark searchBtn" id="searchBtn"><i class="fa fa-search" aria-hidden="true"></i> Find</button>
               </div>
            </div>
         </div>
      </form>
         ...
         <div class="row">
            <div class="col-md-12">
                  <div class="pagination-box hidden-mb-45 text-center">
                     ...
                     <div align="center" id="loadbtndv" class="lead-more" style="display: none;">
      ...
      <div class="modal-content mdc">
         <form method="POST"  enctype="multipart/form-data" id="buyForm">
            ...
            <div class="modal-footer">
               ...
               {{-- <form action="{{url('courses')}}"></form> --}}
               <div class="col-md-4 px-2">
                  <button type="button" id="buyBtn" data-id="" data-price="" class="btn my-1 btn-success btn-block">Yes</button>
                  {{-- <a type="button" id="buyxBtn" data-id="" data-price="" class="btn my-1 btn-success btn-block yecs-buy-course">Yes</a> --}}

               </div>
               <input type="hidden" name="course_id" id="course_id" value="">
               <input type="hidden" name="course_title" id="course_title" class="course_title" value="">
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content mdc">
         <form method="POST"  enctype="multipart/form-data" id="bidForm">
            <input type="hidden" name="_token" value="{{csrf_token()}}">
            <div class="modal-header mdh">
               <h5 class="modal-title mdh2">Bid Now</h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="#000" viewBox="0 0 24 24" width="30" height="30">
                     <path d="M16.24 14.83a1 1 0 0 1-1.41 1.41L12 13.41l-2.83 2.83a1 1 0 0 1-1.41-1.41L10.59 12 7.76 9.17a1 1 0 0 1 1.41-1.41L12 10.59l2.83-2.83a1 1 0 0 1 1.41 1.41L13.41 12l2.83 2.83z"/>
                  </svg>
            ...
            <p>
               ...
               <input type="date" id="dead_line" name="dead_line"  class="form-control form-control-lg">
            ...
            <div class="modal-footer">
               ...
               <div class="col-md-4 px-2">
                  <button type="button" id="bidBtn" data-id="" data-price="" class="btn my-1 btn-success btn-block">Yes</button>
               </div>
...
function get_departments(whose,whose_id,where_id){
      ...
      $.ajax({
               ...
               success: function(response){
                 ...
                 response.optn_values&&response.optn_values.map((item, idx) =>{
                   ...
                   var selected = response.optn_selects[idx];
                   var $newOption = $("<option "+selected+"></option>").val(item).text(text);
                   $("#employees").append($newOption).trigger('ch ange');
                 })
               }
      });
   });
   ...
   $("#company_course").change(function(){
      $("#company-error").addClass('hide');
      $("#company_course").removeClass('error');
   });
   ...
   function showBuyModal(thisObj){
      company_course = $("#company_course").val();
    console.log(thisObj);
      ...
      if(flag == 0){
        ...
        var  purchase_course_title= $(thisObj).attr('data-content');
        $('.course_title').val(purchase_course_title);
   ...
   $("#buyBtn").click(function(){
      ...
      window.location.href = ROOT_URL +"courses/" + courseTitle;
...
<script type="text/javascript">
   ...
   function searchResult(){
     ...
     $.ajax({
       ...
       processData: false,
       success: function(response){
          console.log(response.countCourse);
          if(response.countCourse == 6)
          {
             $('.lead-more').show();
          }
         if(response){
 ...
 function showBidModal(thisObj){
  ...
  $("#bidBtn").click(function(){
     ...
     var  companCourse_id  = $('.company_courses').val();
            ...
            $.ajax({
               ...
               url: COMPANY_URL+'save-bidding-price',
                  data:{course_id:course_id,
                        ...
                        deadLine:deadLine,
                        companCourse_id,companCourse_id,
                        _token: '{{csrf_token()}}'},
                  success: function(response){
                     ...
                     if(response.status ==true || response.status == false){
                       ...
                       $('.waiting'+course_id).show();
                       $('.find-btn'+course_id).hide();
...
<script>
   ...
   $('.yes-buy-course').on('click', function ()
   {
      var courseTitle = $('.course_title').val();
      window.location.href = ROOT_URL +"courses/" + courseTitle;
   });
