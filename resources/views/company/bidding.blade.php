...
<div class="page-content">
   ...
   <div class="panel panel-light">
      <div class="container">
      <form name="Form1" id="Form1" action="{{route('save-bidding-price')}}" method="POST" enctype="multipart/form-data">
         @csrf
         <div class="row mt20">
            <div class="col-md-3">
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  {{-- <select id="course_department" name="course_department" data-toggle="select2" data-search="true" class="form-control"> --}}
                     <select id="category" name="category" data-toggle="select2" data-search="true" class="form-control">
            ...
            <div class="col-md-5">
               <div class="form-group ">
                  ...
                  <select id="company_course" name="course" data-toggle="select2" data-search="true" class="form-control company_course">
                  </select>
                  {!! $errors->has('course')? '<p class="help-block" style="color: red;">'.$errors->first('course').'</p>':'' !!}
               </div>
            </div>
         </div>
         ...
         <div class="row mt20">
            ...
            <div class="col-md-6 mt20 mb20">
               ...
               <div class="form-group">
                  <label for="">Nature of teaching</label>
                  <select id="course_type" name="course_type" data-toggle="select2" data-search="true" class="form-control">
               
                  </select>
                  {!! $errors->has('course_type')? '<p class="help-block" style="color: red;">'.$errors->first('course_type').'</p>':'' !!}
            ...
            <div class="col-md-6 mt20 mb20">
               <div class="form-group">
                  ...
                  {!! $errors->has('employeesCount')? '<p class="help-block" style="color: red;">'.$errors->first('employeesCount').'</p>':'' !!}
            ...
            <div class="col-md-6 mt20 mb20">
               <div class="form-group">
                  ...
                  {!! $errors->has('bidding_price')? '<p class="help-block" style="color: red;">'.$errors->first('bidding_price').'</p>':'' !!}
              
               </div>
            </div>
            <div class="col-md-6 mt20 mb20">
               <div class="form-group">
                  <label for="">Bidding closing date</label>
                  {{-- <select id="employees" name="employees[]" data-toggle="select2" data-search="true" class="form-control" multiple>
                  </select> --}}
            ...
            <div class="col-md-6 mt20 mb20">
               <div class="form-group">
                  ...
                  <input type="file"  name="request_document"  class="form-control form-control-lg">
            ...
            <div class="col-md-6 mt20 mb20">
               <div class="form-group">
                 ...
                 <textarea   id="aditional_info" name="aditional_info"  class="form-control form-control-lg"> </textarea>
               </div>
            </div>
            <div class="col-md-6 mt20 mb20">
               <div class="form-group">
                  <label for="">Course Start Date </label>
                 <input type="date"   id="course_start_date" name="course_start_date"  class="form-control form-control-lg"> 
               </div>
            </div>
            {{-- <div class="col-md-6 mt20 mb20">
               <div class="form-group">
...
$("#category").change(function(){
   ...
   // get_course_type('department',department,'2','course_type');

});
$(".company_course").change(function(){
   course = $(this).val();
  
   get_course_type('department',course,'2','course_type');
...
function get_departments(whose,whose_id,where_id){
      $.ajax({
               type: "POST",
               url: COMPANY_URL+'get-category',
               data:{whose:whose,id:whose_id, _token: '{{csrf_token()}}'},
               success: function(response){
                  $('#'+where_id).empty("<select> </select>");
   ...
   function get_course_type(whose,whose_id,type,where_id){
      // alert(where_id);
      $.ajax({
               type: "POST",
               url: COMPANY_URL+'get-category-course-type',
               data:{whose:whose,
               id:whose_id,
               type:type,
                _token: '{{csrf_token()}}'},
   ...
   function get_courses(whose,whose_id,type,where_id){
      ...
      $.ajax({
               type: "POST",
               url: COMPANY_URL+'get-category-course',
               data:{whose:whose,
               id:whose_id,
               type:type,
                _token: '{{csrf_token()}}'},
               success: function(response){
                  $('#'+where_id).html('<option value="">Select District</option>');
