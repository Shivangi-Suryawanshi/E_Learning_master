...
@section('additional_styles')
    ...
    <link rel="stylesheet" href="{{ asset('users/datepicker/css/bootstrap-datepicker.css') }}">
    <style>
        .mb15 {
            margin-bottom: 15px;
        }
...
@section('content')
            ...
            <main class="">
                ...
                <div class="alert alert-success msgalt" id="successMsg" style="display:none;">
                    <a title="close" aria-label="close" data-dismiss="alert" class="close" href="#">×</a><span
                        id='insSuccess'>Company added Successfully</span>
                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb15">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="dob" class="form-control" id="starts_on"
                                                            value="@if ($contact_details->dob) {{ Carbon\Carbon::parse($contact_details->dob)->format('Y-m-d') }} @endif">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row {{ $errors->has('time_format')? 'has-error':'' }}">
                                                  ...
                                                  <div class="col-sm-8">
                                                      <fieldset>
                                                          ...
                                                          <label>{{ Auth::user()->timezone }}</label> <br />
    ...
    @section('additional_scripts')
                        ...
                        success: function(data) {
                            ...
                            if (data.errors) {
                                ...
                                if (data.errors.company_name_en) {
                                    $('#company_name_enerror').html(data.errors.company_name_en[
                                        0]);
                                } else {
                                ...
                                if (data.errors.company_name_ar) {
                                    ...
                                    $('#company_name_arerror').html(data.errors.company_name_ar[
                                        0]);
                                } else {
                                ...
                                if (data.errors.password_confirmation) {
                                    $('#password_confirmation').html(data.errors
        ...
        <script src="{{ asset('users/datepicker/js/bootstrap-datepicker.js') }}"></script>
