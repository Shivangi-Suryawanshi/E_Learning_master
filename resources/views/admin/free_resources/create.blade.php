    ...
    <main class="">
       ...
       <div class="container">
        ...
        <div class="app-title row">
            ...
            <div class="col-md-2">
            <a class="btn btn-primary" href="{{url('/admin/free-resources')}}"><i class="fa fa-list"></i> Free resources Lists</a>
            </div>
        </div>
        </div>
        ...
        <div class="panel panel-light h-auto">
                                    ...
                                    <div class="panel-body">
                                       <form name="" id="resourceReg" enctype="multipart/form-data" method="POST" action="{{URL('admin/free-resources/create')}}" class="form-horizontal" @submit.prevent="onSubmit">
...
$(document).ready(function(){
 ...
 $('#resourceReg').on('submit', function(event){
  ...
  $.ajax({
   url:"{{URL('admin/free-resources/create')}}",
   method:"POST",
