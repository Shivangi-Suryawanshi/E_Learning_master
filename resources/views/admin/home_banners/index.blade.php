    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="app-title">
                    <div>
                        <h1><i class="fa fa-building"></i> Home Page Banners</h1>
            ...
            <table class="table table-bordered bg-white">
                ...
                @foreach($freeResources as $course)
                    <tr>
                        ...
                        <td><a href="{{ url('admin/home-banner-images/edit/'.$course->id) }}" ><i class="fa fa-pencil-square-o ">&nbsp;&nbsp;</i></a></td>
...
@section('page-js')
   ...
   <script type="text/javascript" src="{{asset('admin/js/bootstrap-switch.min.js')}}"></script>
    ...
    mark: true,
        ajax: {
            url: '{!! URL::to("home_banner_images_data") !!}',
            data: function (d) {
                    }
        },
        columns: [
  ...
  <script src="{{ asset('admin/js/includes/directory/category.js')}}"></script>
