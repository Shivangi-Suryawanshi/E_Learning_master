...
@section('content')
    ...
    style=" background-image: url('{{ theme_asset('website/img/business-coaching/ar-banner.jpg') }}');"
    @else
    style=" background-image: url('{{ asset('home_banners/' . getHomeBannerImg(getHomeBanner('home-section-1')->id)->logo) }}');"
    ...
    @endif
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <p>95% of people learning for professional development report career benefits like getting a promotion, a raise, or starting a new career.</p> --}}
                        ...
                        <form action="{{ route('courses') }}" method="get">
                            <input type="text" class="input-search" name="q" value="{{ request('q') }}"
                                placeholder="{!! __t('what_do_you_want_to_learn') !!}" style="text-align: left;">
        ...
        <div class="business-shape2"><img src="{{ theme_asset('website/img/business-coaching/business-shape2.png') }}"
                alt="image"></div>
    ...
    <section class="courses-categories-area pt-100 pb-100" @if(Session::get('locale')) dir="ltr" @endif>
        <div class="container">
            <div class="section-title text-left">
                <span class="sub-title">{!! __t('courses_categories') !!}</span>
                <h2>{!! __t('most_popular_certificates') !!}</h2>
                <a  href="{{ URL::to('/courses') }}" class="default-btn"><i class='bx bx-show-alt icon-arrow before'
                        style='color: #fff !important;'></i>
                        <span class="label" >{!! __t('view_all') !!}</span>
                        <i
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 p-0">
                    <div class="single-features-box">
                        <div class="inner-content">
                            ...
                            {{-- <a href="#!" class="default-btn"><i class='bx bx-log-in-circle icon-arrow before'></i><span
                                    class="label">{!! __t('btn_learn_more') !!}</span><i
                                    class="bx bx-log-in-circle icon-arrow after"></i></a> --}}
                        </div>
                    </div>
                </div>
    ...
    {{-- <section class="courses-area ptb-100">
        <div class="container">
            <div class="section-title">
                ...
                <p>Explore all of our courses and pick your suitable ones to enroll and start learning with us! We ensure
                    that you will never regret it!</p>
            </div>
            ...
            <div class="row">
                    ...
                    @foreach ($popular_courses as $course)
                        <div class="col-lg-4 col-md-6">
                            <div class="courses-box">
                                <div class="courses-image crsresimg">
                                    <a href="#!" class="d-block image">
                                        <img src="{{ $course->thumbnail_url }}" alt="image">
                                    </a>

                                    <div class="price shadow">
                                        ${{ $course->price_plan == 'paid' ? number_format($course->sale_price) : 'Free' }}
                                    </div>
                                </div>
                                <div class="courses-content">

                                    <h3 class="fs16"><a
                                            href="{{ route('course', $course->slug) }}">{{ $course->title }}</a></h3>
                                    <p>{!! strlen($course->short_description) > 105 ? substr($course->short_description, 0, 109) . '...' : $course->short_description !!}</p>
                                    <ul class="courses-box-footer d-flex justify-content-between align-items-center">
                                        <li><i class='bx bx-book-reader'></i><a
                                                href="{{ route('course', $course->slug) }}" class="txtg">
                                                {{ __t('read_more') }} </a></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="courses-info">
                        <p>{!! __t('content_register_as_individual_user') !!} <a href="{{ URL::to('register/student') }}"
                                id="myBtn8">{!! __t('register_as_individual_user') !!}</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="business-shape5"><img src="{{ theme_asset('website/img/business-coaching/business-shape4.png') }}"
                alt="image"></div>
    </section> --}}
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="become-instructor-partner-content bg-color">
                        ...
                        <a href="{{ URL::to('register/instructor') }}" class="default-btn" id="myBtn6"><i
                                class='bx bx-plus-circle icon-arrow before'></i><span
                                class="label">{{ __t('register') }}</span><i
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="become-instructor-partner-content">
                        ...
                        <a href="{{ URL::to('register/company') }}" class="default-btn" id="myBtn7"><i
                                class='bx bx-plus-circle icon-arrow before'></i><span
                                class="label">{{ __t('register') }}</span><i
                                class="bx bx-plus-circle icon-arrow after"></i></a>
                    </div>
